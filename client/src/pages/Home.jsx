          ...
          <div className=" px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 lg:gap-8">
              ...
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    <span className="text-xl font-bold text-white font-display">WWC</span>
                    <div className="text-xs text-wwc-400 font-medium -mt-1">Video Conferencing</div>
                  </div>
                </div>
                <p className="text-neutral-300 text-base leading-relaxed mb-3 max-w-md">
                  Connect globally, communicate effortlessly with the world's most advanced video conferencing platform.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link to="/signup" className="text-sm text-neutral-300 hover:text-wwc-400 transition-colors duration-200">
                      Get Started
                    </Link>
                  </li>
                  <li>
                    <Link to="/login" className="text-sm text-neutral-300 hover:text-wwc-400 transition-colors duration-200">
                      Sign In
                    </Link>
                  </li>
                  <li>
                    <a href="#features" className="text-sm text-neutral-300 hover:text-wwc-400 transition-colors duration-200">
                      Features
                    </a>
                  </li>
                  <li>
                    <a href="#about" className="text-sm text-neutral-300 hover:text-wwc-400 transition-colors duration-200">
                      About
                    </a>
                  </li>
                </ul>
            ...
            <div className="border-t border-neutral-800 mt-6 pt-4 flex flex-col md:flex-row justify-between items-center">
              <div className="text-xs text-neutral-400 mb-2 md:mb-0">
                © {new Date().getFullYear()} WWC - World Wide Conferencing. All rights reserved.
              </div>
