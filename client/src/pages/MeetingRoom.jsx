        ...
        >
          ...
          <div className="p-6 h-full">
            ...
            >
              ...
              <div
                className={`relative bg-white rounded-xl overflow-hidden shadow-medium border border-neutral-200 h-60 ${
              ...
              {Array.from({ length: Math.max(0, 5 - participants.length) }).map(
                (_, index) => (
                  <div
                    key={`empty-${index}`}
                    className="bg-neutral-50 border-2 border-dashed border-neutral-200 rounded-xl flex items-center justify-center hover:bg-neutral-100 transition-colors duration-200 h-60"
                  >
        ...
        {showParticipants && (
          <div className="w-80 bg-white border-l border-neutral-200 flex flex-col shadow-medium">
            <div className="p-4 border-b border-neutral-200">
              <h3 className="font-bold text-neutral-900 font-display">
